    ...
    <PageWithBackground>
      <header className="sticky top-0 z-10 border-b border-zinc-200/80 bg-white/85 backdrop-blur-md dark:border-zinc-700/80 dark:bg-zinc-950/85">
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-6 py-4 sm:px-8">
          <Link href="/" className="smooth-nav-link font-semibold text-zinc-900 dark:text-zinc-50">
            Strivon
          </Link>
      ...
      <main className="mx-auto max-w-2xl px-6 py-16 sm:px-8 sm:py-20">
        <h1 className="animate-fade-in-up text-3xl font-bold tracking-tight text-zinc-900 dark:text-zinc-50">Terms of Service</h1>
        ...
        <Link href="/" className="smooth-nav-link mt-8 inline-block text-sm font-medium text-zinc-600 underline hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-100">
          ← Back to home
        </Link>
      </main>
    </PageWithBackground>
