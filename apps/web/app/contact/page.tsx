...
export const metadata: Metadata = {
  title: "Contact",
  description: "Get in touch with Strivon.",
};

const CONTACT_EMAIL = "hello@strivon.app";
  ...
  return (
    <PageWithBackground>
      ...
      <main className="mx-auto max-w-2xl px-6 py-16 sm:px-8 sm:py-20">
        <h1 className="animate-fade-in-up text-3xl font-bold tracking-tight text-[var(--foreground)]">Contact</h1>
        <p className="mt-4 text-[var(--muted)]">
          Questions or feedback? Reach us by email.
        </p>
        <ContactContent email={CONTACT_EMAIL} />
